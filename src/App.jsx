...
export default function App() {
  ...
  const search = (query) =>
    fakeSchoolsData.filter((school) => school.name.includes(query));
  ...
  const comparisonData =
    selected1 && selected2
      ? [
          {
            name: "Classes",
            [selected1.name]: selected1.classes,
            [selected2.name]: selected2.classes,
          },
          {
            name: "Teachers",
            [selected1.name]: selected1.teachers,
            [selected2.name]: selected2.teachers,
          },
          {
            name: "Students",
            [selected1.name]: selected1.students,
            [selected2.name]: selected2.students,
          },
          {
            name: "Reputation",
            [selected1.name]: selected1.reputation,
            [selected2.name]: selected2.reputation,
          },
        ]
      : [];
